...
This project contains a number of converters to and from differnt Blog
services.  The code is written in Python with scripts to execute the 
conversions either through command-line scripts or hosted on Google App Engine.
This project is open source and distributed under the Apache license.  Please
feel free to add to or modify this source and propose changes or new 
converters.
